   ...
   <!-- End header -->
          <nav class="col-md-8">
              ...
              <div class="d-flex justify-content-between">
                  <h2 class='d-inline'>Account Admin</h2>
                  <a href="../insertAccount?maQuyen=admin" class="btn btn-outline-success d-inline-block mb-3 mt-2">Thêm Mới</a>
                  </div>
                  ...
                  <tbody>
                    ...
                    if(isset($_GET['search'])){
                        if(empty($_GET['search'])){
                          $sql="SELECT * FROM user WHERE maQuyen='admin'";
                        }
                        else{
                          $sql= "SELECT * FROM user WHERE maQuyen='admin' and email like '%$search%' or name like '%$search%'";
                        }
                    }
                    else{
                      $sql="SELECT * FROM user WHERE maQuyen='admin'";
