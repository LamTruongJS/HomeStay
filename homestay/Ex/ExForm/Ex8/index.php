...
<body>
    <form action="index2.php" enctype="multipart/form-data" method="post" class="w-25">
        <div class="mb-3">
        ...
        <div class="mb-3 form-check-inline">
            <input type="checkbox" class="form-check-input" id="code" name="hobby[]" value="Code" />
            <label class="form-check-label" for="code">Code</label>
        </div>
        <div class="mb-3 form-check-inline">
            <input type="checkbox" class="form-check-input" id="sleep" name="hobby[]" value="Sleep" />
