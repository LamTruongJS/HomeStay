...
<body>
    <?php
    function Test($NumberFirst, $NumberSecond, $calculation){   
        if(!is_numeric($NumberFirst) || !is_numeric($NumberSecond) || ($calculation ==="Chia" && $NumberSecond==0)){
    ...
    $Result="0";
    Test($NumberFirst,$NumberSecond,$calculation);
    switch($calculation){
    ...
    <div class="container">
        ...
        <div class="content">
            <a href="javascript:window.history.back(-1);" class="btn">Quay lại trang trước</a>
        </div>
