...
<body>
        ...
        if(isset($_POST['tinh'])){
            ...
            if (!is_numeric($number) || $number < 1 || $number != round($number)) {
                ...
                for($i=0;$i<$number; $i++){
                    ...
                    $localtionZero .= $randomArray[$i]===0 ? "$i, ":'';
                }
    ...
    <form action="index.php" class="container" method="POST">
        ...
        <div class="content">
            ...
            <input type="text" name="phanTu100" class="disabled" readonly
                value="<?php echo $numberSmallerHundered??'' ?>" />
        </div>
        <div class="content">
        ...
        <div class="content">
            ...
            <input type="text" name="viTriPhanTu0" class="disabled" readonly
                value="<?php echo  $localtionZero==''?'Không có phần tử 0':$localtionZero ?>" />
        </div>
        <div class="content">
            <label class="label">Sắp xếp mảng tăng dần:</label>
            <input type="text" name="mangTangDan" class="disabled" readonly
                value="<?php echo  $arrayIncrement??'' ?>" />
        </div>
