...
if (isset($_POST['forgotpassword'])) {
  ...
  if ($num_rowsEmail != 0 && $password === $confirm_password) {
    $randomCODE=rand(1000,9999);
      ...
      include '../sendmail/lienhe.php';
      header('Location: /homestay/confirmPincode/');
  ...
  <div class="container">
    <form class="form__register" action="index.php" method="post">
      ...
      <div class="form__register__email">
        ...
        <input type="email" class="form__register__email--input" name="email" required maxlength="50" value="<?php if (isset($_POST['email'])) echo $_POST['email'];
                                                                                                              else echo '' ?>" />
      </div>
      ...
      <div class="form__register__password">
        ...
        <input type="password" class="form__register__password--input" name="password" required maxlength="20" value="<?php if (isset($_POST['password'])) echo $_POST['password'];
                                                                                                                      else echo '' ?>" />
      ...
      <div class="form__register__confirm__password">
        ...
        <input type="password" class="form__register__confirm__password--input" name="confirm_password" required maxlength="20" value="<?php if (isset($_POST['confirm_password'])) echo $_POST['confirm_password'];
                                                                                                                                        else echo '' ?>" />
