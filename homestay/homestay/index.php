    ...
    <?php 
        ...
        if(isset($_POST['add'])){
                ...
                if($result2->num_rows ==0){
                    ...
                    $sql5="INSERT INTO ct_gio_hang values('$index','$maHomeStay')";
                ...
                //nếu đã có giỏ hàng
                    ...
                    $maGH=$row2['maGH'];
                    $sql6="SELECT * FROM ct_gio_hang WHERE maHST='$maHomeStay' and maGH='$maGH'";
                    $result6=mysqli_query($conn,$sql6);
                    //nếu chưa có sản phẩm trong giỏ hàng
                    if($result6->num_rows ==0){
                        $sql7="INSERT INTO ct_gio_hang values('$maGH','$maHomeStay')";
                     
                        $result7=mysqli_query($conn,$sql7);
                        header("Location: /homestay/cart/");   
                    }
                    // nếu đã có sản phầm trong giỏ hàng
                    header("Location: /homestay/cart/");
                }
